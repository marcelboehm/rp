...
set INSIGHTFACE_PACKAGE_URL=https://github.com/C0untFloyd/rp-unleashed/releases/download/3.6.6/insightface-0.7.3-cp310-cp310-win_amd64.whl
...
if "%ffmpeg_exists%" == "F" (
    if not exist "%INSTALL_FFMPEG_DIR%" (
        ...
        echo To use videos, you need to restart rp after this installation.
        cd ..
    )
) else (
